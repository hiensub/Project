                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="mb-3">
                                ...
                                <input name="code" value="<?= $row['code']; ?>" id="code" type="text"
                                    class="form-control" required placeholder="">
                            </div>
                            <div class="mb-3">
                                <label for="deliveryaddress"> Địa chỉ </label>
                                <input name="deliveryaddress" value="<?= $row['deliveryaddress']; ?>"
                                    id="deliveryaddress" type="text" class="form-control" required placeholder="">
                                </input>
                            </div>
                            <div class="mb-3">
                                <label for="deliveryname"> Tên khách hàng </label>
                                <input name="deliveryname" value="<?= $row['deliveryname']; ?>" id="deliveryname"
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input name="deliveryphone" value="<?= $row['deliveryphone']; ?>" id="deliveryphone"
                                    type="text" class="form-control" required placeholder="">

                            </div>
                            <div class="mb-3">
                                <label for="deliveryemail"> Email </label>
                                <input name="deliveryemail" value="<?= $row['deliveryemail']; ?>" id="deliveryemail"
                                    type="text" class="form-control" required placeholder="">
